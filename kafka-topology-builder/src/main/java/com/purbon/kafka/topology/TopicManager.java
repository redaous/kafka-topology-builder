...
public class TopicManager {
  ...
  public void syncTopic(TopicImpl topic, String fullTopicName, Set<String> listOfTopics) {
  ...
  public void syncTopic(TopicImpl topic, Set<String> listOfTopics, Topology topology, Project project) {
    String fullTopicName = topic.toString();
    syncTopic(topic, fullTopicName, listOfTopics);
  }
